...
import com.tita.aixiaoyuan.utils.LifecycleApplication;
...
public class EmojiDao {
    ...
    public static String CopySqliteFileFromRawToDatabases(String SqliteFileName) throws IOException {
        ...
        //复制的话这里需要换成自己项目的包名
        File dir = new File("data/data/" + "com.tita.aixiaoyuan" + "/databases");
        ...
        if (!file.exists()) {
            try {
                file.createNewFile();
                inputStream = LifecycleApplication.mApplication.getClass().getClassLoader().getResourceAsStream("assets/" + SqliteFileName);
