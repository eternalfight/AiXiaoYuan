...
import scut.carson_ho.searchview.utils.KeyBoardUtil;
import scut.carson_ho.searchview.utils.StorageListSPUtils;
import scut.carson_ho.searchview.widget.FlowLayout;
...
public class SearchActivity extends AppCompatActivity implements TextView.OnEditorActionListener, View.OnClickListener {
   ...
   /* @BindView(R.id.header_cancel_tv)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msearch_btn_search.setOnClickListener(this);
