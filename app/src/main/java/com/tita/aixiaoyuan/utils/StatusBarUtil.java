...
public class StatusBarUtil {
     ...
     */
    public static void setFitsSystemWindow(Activity activity,boolean value,int Color){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            activity.getWindow().setStatusBarColor(ContextCompat.getColor(activity.getApplicationContext(),Color));//设置状态栏颜色
