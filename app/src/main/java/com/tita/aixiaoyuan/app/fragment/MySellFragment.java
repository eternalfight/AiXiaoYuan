...
public class MySellFragment extends BaseFragmentJava{
    ...
    protected int setLayoutResourceID() {
        return R.layout.fragment_mysell;
    }
    ...
    private void doSearch(){
        ...
        String bql ="select * from productInfoBean where username ='"+username+"' and sellout = 1";
