...
public class Fragment_wait_for_evaluate extends BaseFragmentJava {
    ...
    protected int setLayoutResourceID() {
        return R.layout.fragment_wait_for_evaluate;
    }
    ...
    private void doSearch(){
        ...
        String bql ="select * from MyOrderBean where username ='"+username+"' and order_status ="+3;
