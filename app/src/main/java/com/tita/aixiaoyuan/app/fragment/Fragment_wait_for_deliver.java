...
public class Fragment_wait_for_deliver extends BaseFragmentJava {
    ...
    protected int setLayoutResourceID() {
        return R.layout.fragment_wait_for_deliver;
    }
    ...
    private void doSearch(){
        ...
        String bql ="select * from MyOrderBean where username ='"+username+"' and order_status ="+1;
